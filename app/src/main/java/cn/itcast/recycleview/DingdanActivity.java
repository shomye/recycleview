...
//                startActivity(intent); //启动调用
            ...
            //market为路径，id为包名
            //显示手机上所有的market商店
            Toast.makeText(DingdanActivity.this, "You have not installed Baidu Map", Toast.LENGTH_LONG).show();
...
//                    "34.264642646862" + "&lon=" + "108.95108518068" + "&dev=1&style=2");
            ...
            Toast.makeText(DingdanActivity.this, "You have not installed Gaode Map", Toast.LENGTH_LONG).show();
